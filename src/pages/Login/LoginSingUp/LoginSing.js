     ...
     <div className='text-center'>
        ...
        <div className='h-128 w-80 border-x-2 border-y-2 mx-auto mt-5 p-4 rounded-md'>
              ...
              <div className='mt-3'>
                ...
                <input type={'email'} name='email' className='w-full border-x border-y border-gray-400 h-7'/>
              </div>
              <div className='mt-4 text-sm font-medium '>
                ...
                <input type={'password'} name='password' className='w-full h-7 border-x border-y border-gray-400'/>
              </div>
              <Link  ><button className='w-full h-8 bg-gradient-to-t from-yellow-500 to-white rounded-md mt-5'>Giriş Yap</button></Link>
              <div>
